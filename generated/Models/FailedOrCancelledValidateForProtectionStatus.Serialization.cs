...
{
    public partial class FailedOrCancelledValidateForProtectionStatus : IUtf8JsonSerializable
    {
        ...
        internal static FailedOrCancelledValidateForProtectionStatus DeserializeFailedOrCancelledValidateForProtectionStatus(JsonElement element)
        {
            ...
            return new FailedOrCancelledValidateForProtectionStatus(Optional.ToDictionary(additionalProperties), telemetryData.Value, Optional.ToNullable(retryAfterOnRetryableErrorInSeconds), error.Value);
        }
    }
}
