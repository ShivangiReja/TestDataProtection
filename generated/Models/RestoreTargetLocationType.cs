...
namespace DataProtectionPlugin.Models
{
    ...
    public readonly partial struct RestoreTargetLocationType : IEquatable<RestoreTargetLocationType>
    {
        ...
        private const string AzureDisksValue = "AzureDisks";
        private const string AzureFilesValue = "AzureFiles";
        private const string AzureKubernetesWorkloadValue = "AzureKubernetesWorkload";
        ...
        /// <summary> AzureDisks. </summary>
        public static RestoreTargetLocationType AzureDisks { get; } = new RestoreTargetLocationType(AzureDisksValue);
        ...
        /// <summary> AzureKubernetesWorkload. </summary>
        public static RestoreTargetLocationType AzureKubernetesWorkload { get; } = new RestoreTargetLocationType(AzureKubernetesWorkloadValue);
