...
namespace DataProtectionPlugin.Models
{
    public partial class BackupRequest : IUtf8JsonSerializable
    {
        ...
        internal static BackupRequest DeserializeBackupRequest(JsonElement element)
        {
            ...
            return new BackupRequest(jobLibraryInitializationParams.Value, datasourceAccessToken.Value, Optional.ToDictionary(additionalProperties), datasourceSet.Value, datasource, rpCatalogInitializeParams, datastoreInitializeParams, backupParameters, loopBackContext.Value);
        }
    }
}
