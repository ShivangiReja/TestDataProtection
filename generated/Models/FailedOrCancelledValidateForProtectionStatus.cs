...
namespace DataProtectionPlugin.Models
{
    ...
    public partial class FailedOrCancelledValidateForProtectionStatus : ValidateForProtectionStatus
    {
        ...
        public FailedOrCancelledValidateForProtectionStatus()
        {
        }
        ...
        internal FailedOrCancelledValidateForProtectionStatus(IDictionary<string, string> additionalProperties, string telemetryData, int? retryAfterOnRetryableErrorInSeconds, Error error) : base(additionalProperties, telemetryData, retryAfterOnRetryableErrorInSeconds)
        {
            Error = error;
        }
