...
{
    public partial class RestoreStatus : IUtf8JsonSerializable
    {
        ...
        internal static RestoreStatus DeserializeRestoreStatus(JsonElement element)
        {
            ...
            return new RestoreStatus(Optional.ToDictionary(additionalProperties), telemetryData.Value, Optional.ToNullable(retryAfterOnRetryableErrorInSeconds), loopBackContext.Value);
        }
    }
}
