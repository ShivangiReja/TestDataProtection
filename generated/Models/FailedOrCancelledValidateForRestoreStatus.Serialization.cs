...
{
    public partial class FailedOrCancelledValidateForRestoreStatus : IUtf8JsonSerializable
    {
        ...
        internal static FailedOrCancelledValidateForRestoreStatus DeserializeFailedOrCancelledValidateForRestoreStatus(JsonElement element)
        {
            ...
            return new FailedOrCancelledValidateForRestoreStatus(Optional.ToDictionary(additionalProperties), telemetryData.Value, Optional.ToNullable(retryAfterOnRetryableErrorInSeconds), loopBackContext.Value, error.Value);
        }
    }
}
