...
{
    public partial class CommitOrRollbackRestoreStatus : IUtf8JsonSerializable
    {
        ...
        internal static CommitOrRollbackRestoreStatus DeserializeCommitOrRollbackRestoreStatus(JsonElement element)
        {
            ...
            return new CommitOrRollbackRestoreStatus(Optional.ToDictionary(additionalProperties), telemetryData.Value, Optional.ToNullable(retryAfterOnRetryableErrorInSeconds), Optional.ToNullable(originalDatasourceSizeInBytes), Optional.ToNullable(dataTransferredInBytes));
        }
    }
}
