...
{
    public partial class BackupStatus : IUtf8JsonSerializable
    {
        ...
        internal static BackupStatus DeserializeBackupStatus(JsonElement element)
        {
            ...
            return new BackupStatus(Optional.ToDictionary(additionalProperties), telemetryData.Value, Optional.ToNullable(retryAfterOnRetryableErrorInSeconds), loopBackContext.Value);
        }
    }
}
