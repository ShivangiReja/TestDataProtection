...
{
    /// <summary> CommitOrRollbackRestoreRequest for the CommitOrRollbackRestore operation. </summary>
    public partial class CommitOrRollbackRestoreRequest : RestoreRequestBase
    {
        /// <summary> Initializes a new instance of CommitOrRollbackRestoreRequest. </summary>
        ...
        public CommitOrRollbackRestoreRequest(RestoreType restoreType, Datasource sourceDatasource, bool forceOverwrite) : base(restoreType, sourceDatasource, forceOverwrite)
        {
