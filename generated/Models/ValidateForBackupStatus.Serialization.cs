...
{
    public partial class ValidateForBackupStatus : IUtf8JsonSerializable
    {
        ...
        internal static ValidateForBackupStatus DeserializeValidateForBackupStatus(JsonElement element)
        {
            ...
            return new ValidateForBackupStatus(Optional.ToDictionary(additionalProperties), telemetryData.Value, Optional.ToNullable(retryAfterOnRetryableErrorInSeconds), loopBackContext.Value);
        }
    }
}
