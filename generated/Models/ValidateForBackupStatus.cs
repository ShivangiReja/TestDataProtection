...
{
    /// <summary> ValidateForBackupStatus for the validate for backup operation. </summary>
    public partial class ValidateForBackupStatus : BaseStatus
    {
        /// <summary> Initializes a new instance of ValidateForBackupStatus. </summary>
        public ValidateForBackupStatus()
        {
        }
        ...
        internal ValidateForBackupStatus(IDictionary<string, string> additionalProperties, string telemetryData, int? retryAfterOnRetryableErrorInSeconds, string loopBackContext) : base(additionalProperties, telemetryData, retryAfterOnRetryableErrorInSeconds)
        {
