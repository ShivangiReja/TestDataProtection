...
{
    public partial class StartProtectionStatus : IUtf8JsonSerializable
    {
        ...
        internal static StartProtectionStatus DeserializeStartProtectionStatus(JsonElement element)
        {
            ...
            return new StartProtectionStatus(Optional.ToDictionary(additionalProperties), telemetryData.Value, Optional.ToNullable(retryAfterOnRetryableErrorInSeconds));
        }
    }
}
