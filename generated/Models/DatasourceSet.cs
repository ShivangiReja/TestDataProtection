...
{
    /// <summary> DatasourceSet class with properties common to all fabric types. </summary>
    public partial class DatasourceSet
    {
        /// <summary> Initializes a new instance of DatasourceSet. </summary>
        ...
        internal DatasourceSet(string resourceID, string resourceUri, string baseUri, string datasourceType, string resourceName, string resourceType, string resourceLocation, BaseResourceProperties resourceProperties, string objectType)
        {
            ResourceID = resourceID;
