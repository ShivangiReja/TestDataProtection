...
namespace DataProtectionPlugin.Models
{
    ...
    public partial class FailedOrCancelledStopProtectionStatus : StopProtectionStatus
    {
        ...
        public FailedOrCancelledStopProtectionStatus()
        {
        }
        ...
        internal FailedOrCancelledStopProtectionStatus(IDictionary<string, string> additionalProperties, string telemetryData, int? retryAfterOnRetryableErrorInSeconds, Error error) : base(additionalProperties, telemetryData, retryAfterOnRetryableErrorInSeconds)
        {
            Error = error;
        }
