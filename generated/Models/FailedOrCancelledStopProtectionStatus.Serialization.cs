...
{
    public partial class FailedOrCancelledStopProtectionStatus : IUtf8JsonSerializable
    {
        ...
        internal static FailedOrCancelledStopProtectionStatus DeserializeFailedOrCancelledStopProtectionStatus(JsonElement element)
        {
            ...
            return new FailedOrCancelledStopProtectionStatus(Optional.ToDictionary(additionalProperties), telemetryData.Value, Optional.ToNullable(retryAfterOnRetryableErrorInSeconds), error.Value);
        }
    }
}
