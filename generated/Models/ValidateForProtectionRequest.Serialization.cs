...
{
    public partial class ValidateForProtectionRequest : IUtf8JsonSerializable
    {
        ...
        internal static ValidateForProtectionRequest DeserializeValidateForProtectionRequest(JsonElement element)
        {
            ...
            return new ValidateForProtectionRequest(jobLibraryInitializationParams.Value, datasourceAccessToken.Value, Optional.ToDictionary(additionalProperties), datasourceSet.Value, datasource, backupSettings);
        }
    }
}
