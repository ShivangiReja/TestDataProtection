...
{
    public partial class FailedOrCancelledStartProtectionStatus : IUtf8JsonSerializable
    {
        ...
        internal static FailedOrCancelledStartProtectionStatus DeserializeFailedOrCancelledStartProtectionStatus(JsonElement element)
        {
            ...
            return new FailedOrCancelledStartProtectionStatus(Optional.ToDictionary(additionalProperties), telemetryData.Value, Optional.ToNullable(retryAfterOnRetryableErrorInSeconds), error.Value);
        }
    }
}
