...
{
    public partial class BaseRequest : IUtf8JsonSerializable
    {
        ...
        internal static BaseRequest DeserializeBaseRequest(JsonElement element)
        {
            ...
            return new BaseRequest(jobLibraryInitializationParams.Value, datasourceAccessToken.Value, Optional.ToDictionary(additionalProperties));
        }
    }
}
