...
{
    public partial class CommitOrRollbackRestoreRequest : IUtf8JsonSerializable
    {
        ...
        internal static CommitOrRollbackRestoreRequest DeserializeCommitOrRollbackRestoreRequest(JsonElement element)
        {
            ...
            return new CommitOrRollbackRestoreRequest(jobLibraryInitializationParams.Value, datasourceAccessToken.Value, Optional.ToDictionary(additionalProperties), restoreType, sourceDatasourceSet.Value, sourceDatasource, targetDatasourceSet.Value, targetDatasource.Value, restoreAsFilesTargetDetails.Value, Optional.ToList(ilrRestoreCriteria), restoreToRPId.Value, restoreToPointInTime.Value, Optional.ToDictionary(rpCatalogInitializeParams), Optional.ToDictionary(datastoreInitializeParams), forceOverwrite, loopBackContext.Value);
        }
    }
}
