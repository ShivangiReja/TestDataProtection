...
{
    public partial class StopProtectionStatus : IUtf8JsonSerializable
    {
        ...
        internal static StopProtectionStatus DeserializeStopProtectionStatus(JsonElement element)
        {
            ...
            return new StopProtectionStatus(Optional.ToDictionary(additionalProperties), telemetryData.Value, Optional.ToNullable(retryAfterOnRetryableErrorInSeconds));
        }
    }
}
