...
{
    public partial class ValidateForProtectionStatus : IUtf8JsonSerializable
    {
        ...
        internal static ValidateForProtectionStatus DeserializeValidateForProtectionStatus(JsonElement element)
        {
            ...
            return new ValidateForProtectionStatus(Optional.ToDictionary(additionalProperties), telemetryData.Value, Optional.ToNullable(retryAfterOnRetryableErrorInSeconds));
        }
    }
}
