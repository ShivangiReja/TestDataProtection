...
{
    public partial class ValidateForRestoreStatus : IUtf8JsonSerializable
    {
        ...
        internal static ValidateForRestoreStatus DeserializeValidateForRestoreStatus(JsonElement element)
        {
            ...
            return new ValidateForRestoreStatus(Optional.ToDictionary(additionalProperties), telemetryData.Value, Optional.ToNullable(retryAfterOnRetryableErrorInSeconds), loopBackContext.Value);
        }
    }
}
