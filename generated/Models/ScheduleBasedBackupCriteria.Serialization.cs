...
namespace DataProtectionPlugin.Models
{
    public partial class ScheduleBasedBackupCriteria : IUtf8JsonSerializable
    {
        ...
        internal static ScheduleBasedBackupCriteria DeserializeScheduleBasedBackupCriteria(JsonElement element)
        {
            ...
            return new ScheduleBasedBackupCriteria(objectType, Optional.ToList(absoluteCriteria), Optional.ToList(scheduleTimes), Optional.ToList(daysOfMonth), Optional.ToList(weeksOfTheMonth), Optional.ToList(daysOfTheWeek), Optional.ToList(monthsOfYear));
        }
    }
}
