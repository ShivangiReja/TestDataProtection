...
{
    public partial class CommitOrRollbackBackupStatus : IUtf8JsonSerializable
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer)
        {
            ...
            {
                writer.WritePropertyName("datasourceSizeInBytes");
        ...
        internal static CommitOrRollbackBackupStatus DeserializeCommitOrRollbackBackupStatus(JsonElement element)
        {
            ...
            return new CommitOrRollbackBackupStatus(Optional.ToDictionary(additionalProperties), telemetryData.Value, Optional.ToNullable(retryAfterOnRetryableErrorInSeconds), Optional.ToNullable(datasourceSizeInBytes), Optional.ToNullable(dataTransferredInBytes));
        }
    }
}
