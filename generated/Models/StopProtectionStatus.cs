...
namespace DataProtectionPlugin.Models
{
    ...
    public partial class StopProtectionStatus : BaseStatus
    {
        ...
        internal StopProtectionStatus(IDictionary<string, string> additionalProperties, string telemetryData, int? retryAfterOnRetryableErrorInSeconds) : base(additionalProperties, telemetryData, retryAfterOnRetryableErrorInSeconds)
        {
        }
    }
}
