...
{
    public partial class StartProtectionRequest : IUtf8JsonSerializable
    {
        ...
        internal static StartProtectionRequest DeserializeStartProtectionRequest(JsonElement element)
        {
            ...
            return new StartProtectionRequest(jobLibraryInitializationParams.Value, datasourceAccessToken.Value, Optional.ToDictionary(additionalProperties), datasourceSet.Value, datasource, backupSettings);
        }
    }
}
