...
{
    public partial class ValidateForBackupRequest : IUtf8JsonSerializable
    {
        ...
        internal static ValidateForBackupRequest DeserializeValidateForBackupRequest(JsonElement element)
        {
            ...
            return new ValidateForBackupRequest(jobLibraryInitializationParams.Value, datasourceAccessToken.Value, Optional.ToDictionary(additionalProperties), datasourceSet.Value, datasource, rpCatalogInitializeParams, datastoreInitializeParams, backupParameters);
        }
    }
}
