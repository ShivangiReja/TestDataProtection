...
{
    public partial class FailedOrCancelledRestoreStatus : IUtf8JsonSerializable
    {
        ...
        internal static FailedOrCancelledRestoreStatus DeserializeFailedOrCancelledRestoreStatus(JsonElement element)
        {
            ...
            return new FailedOrCancelledRestoreStatus(Optional.ToDictionary(additionalProperties), telemetryData.Value, Optional.ToNullable(retryAfterOnRetryableErrorInSeconds), loopBackContext.Value, error.Value);
        }
    }
}
