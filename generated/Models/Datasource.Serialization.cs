...
namespace DataProtectionPlugin.Models
{
    public partial class Datasource : IUtf8JsonSerializable
    {
        ...
        internal static Datasource DeserializeDatasource(JsonElement element)
        {
            ...
            return new Datasource(resourceID, resourceUri.Value, baseUri.Value, datasourceType.Value, resourceName.Value, resourceType.Value, resourceLocation.Value, resourceProperties.Value, objectType.Value);
        }
    }
}
