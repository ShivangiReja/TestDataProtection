...
{
    public partial class StopProtectionRequest : IUtf8JsonSerializable
    {
        ...
        internal static StopProtectionRequest DeserializeStopProtectionRequest(JsonElement element)
        {
            ...
            return new StopProtectionRequest(jobLibraryInitializationParams.Value, datasourceAccessToken.Value, Optional.ToDictionary(additionalProperties), datasourceSet.Value, datasource, backupSettings);
        }
    }
}
