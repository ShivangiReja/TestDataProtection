...
namespace DataProtectionPlugin.Models
{
    public partial class BlobBackupDatasourceParameters : IUtf8JsonSerializable
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer)
        {
            ...
            {
                writer.WritePropertyName("containersList");
        ...
        {
            Optional<IList<string>> containersList = default;
            string objectType = default;
            foreach (var property in element.EnumerateObject())
            {
                if (property.NameEquals("containersList"))
                {
            ...
            return new BlobBackupDatasourceParameters(objectType, Optional.ToList(containersList));
        }
    }
}
