...
{
    public partial class RestoreRequestBase : IUtf8JsonSerializable
    {
        ...
        internal static RestoreRequestBase DeserializeRestoreRequestBase(JsonElement element)
        {
            ...
            return new RestoreRequestBase(jobLibraryInitializationParams.Value, datasourceAccessToken.Value, Optional.ToDictionary(additionalProperties), restoreType, sourceDatasourceSet.Value, sourceDatasource, targetDatasourceSet.Value, targetDatasource.Value, restoreAsFilesTargetDetails.Value, Optional.ToList(ilrRestoreCriteria), restoreToRPId.Value, restoreToPointInTime.Value, Optional.ToDictionary(rpCatalogInitializeParams), Optional.ToDictionary(datastoreInitializeParams), forceOverwrite);
        }
    }
}
